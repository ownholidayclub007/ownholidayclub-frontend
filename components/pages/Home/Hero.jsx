            ...
            >
              ...
              >
                <button
                  ...
                  className="shrink-0 whitespace-nowrap rounded-full bg-yellow-400 px-3 py-2 sm:px-8 sm:py-3.5 text-[8px] sm:text-[12px] font-bold uppercase tracking-widest text-slate-900 transition-all duration-300 hover:bg-yellow-300 hover:scale-105 shadow-xl shadow-yellow-500/20"
                >
